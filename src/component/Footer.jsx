    ...
    <>
      <div className="relative py-8">
        ...
        <div className="relative z-10 container mx-auto px-4 py-6 bg-white bg-opacity-90 rounded-lg shadow-lg">
          <div className="grid grid-cols-1 md:grid-cols-1 p-2 "> {/* Reduced gap here */}
            <div className="flex flex-col items-center md:items-start">
              <Image src={Logo} alt="logo" height={100} width={125} />
            </div>
            <div className="flex flex-col md:flex-row md:justify-between gap-2 w-full"> {/* Added full width here */}
              <div className="flex flex-col w-full md:w-1/2"> {/* Adjusted width here */}
              ...
              <div className="flex flex-col w-full md:w-1/2"> {/* Adjusted width here */}
                <h2 className="text-teal-700 mt-4 font-bold text-lg">Resource Links</h2>
                <ul className="mt-2 space-y-2">
                  <li>
                    <a href="https://www.universitycourses.com.au/" className="relative group text-gray-700">
                      University Courses in Australia
                      <span className="absolute block w-full h-1 bg-teal-600 bottom-0 left-0 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></span>
                    </a>
                  </li>
                  <li>
                    <a href="https://www.seek.com.au/" className="relative group text-gray-700">
                      Seek Australia
                      <span className="absolute block w-full h-1 bg-teal-600 bottom-0 left-0 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></span>
                    </a>
                  </li>
                  <li>
                    <a href="https://www.jobsandskills.gov.au/" className="relative group text-gray-700">
              ...
              <div className="flex flex-col w-full md:w-1/2"> {/* Adjusted width here */}
                <h2 className="text-teal-700 mt-4 font-bold text-lg">Important Links</h2>
                <ul className="mt-2 space-y-2">
                  <li>
                    <a href="https://bisu-consultancy.vercel.app/aboutus" className="relative group text-gray-700">
                      About Us
              ...
              <div className="flex flex-col items-center md:items-end w-full md:w-auto"> {/* Adjusted width here */}
