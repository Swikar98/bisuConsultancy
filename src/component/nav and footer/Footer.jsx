          ...
          <div className="grid grid-cols-1  md:grid-cols-3 lg:grid-cols-5 gap-4 p-2">
            <div className="flex flex-col items-center md:items-start w-full">
              ...
              <div className="flex flex-col items-center md:items-start mt-8">
                <h2 style={{ textDecoration: "underline" }} className="text-teal-700 font-bold text-lg">
                  FOLLOW US
                </h2>
            ...
            {footerData.links.map((section, index) => (
              <div key={index} className="flex flex-col space-y-4">
                <h2 className="text-teal-700 font-bold text-lg underline">
                  {section.category}
                </h2>
                <ul className="space-y-2">
                  {section.items.map((item, itemIndex) => (
                    <li key={itemIndex} className="flex items-center">
                      <FaArrowRight className="mr-2 text-teal-600" />
